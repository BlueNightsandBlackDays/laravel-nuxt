<template>
  <el-aside class="aside aside-fixed" :class="{ 'minimize': isMinimized, 'maximize': isHovering && isMinimized }">
    <template v-if="user">
      <!-- Sidebar header  -->
        ...
        <div class="aside-loggedin">
          ...
          <div class="d-flex align-items-center justify-content-start">
            <el-tooltip :content="$t('user_profile')">
              <div class="avatar">
                <img v-if="user.photo_url" :src="user.photo_url" class="rounded-circle w-100 h-100 " alt="User profile">
                <img v-else src="https://via.placeholder.com/500" class="rounded-circle w-100 h-100" alt="image">
              </div>
            </el-tooltip>
